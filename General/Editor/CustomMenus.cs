...
namespace Pseudo.Editor.Internal
{
	public static class CustomMenus
	{
		...
		static string GetNewCopyMethod(Type type, string typeName, int indent, params string[] membersToIgnore)
		{
			...
			var body = "public void Copy(" + typeName + " reference)\r\n";
			...
			var fields = type.GetFields(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
