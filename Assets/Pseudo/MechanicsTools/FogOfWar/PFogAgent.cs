...
namespace Pseudo
{
	...
	public class PFogAgent : PMonoBehaviour
	{
		...
		List<PFogOfWar> fogsOfWar = new List<PFogOfWar>();

		Dictionary<PFogOfWar, Vector3> relativePositionsDict = new Dictionary<PFogOfWar, Vector3>();

		void OnEnable()
		{
			for (int i = 0; i < fogsOfWar.Count; i++)
			{
				PFogOfWar fogOfWar = fogsOfWar[i];
		...
		public void AddFogOfWar(PFogOfWar fogOfWar)
		{
			fogOfWar.UpdateFogOfWar = true;
		...
		public void RemoveFogOfWar(PFogOfWar fogOfWar)
		{
			fogOfWar.UpdateFogOfWar = true;
		...
		public List<PFogOfWar> GetFogsOfWar()
		{
			return fogsOfWar;
		}
