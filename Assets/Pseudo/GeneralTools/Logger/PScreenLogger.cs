...
{
	public class PScreenLogger : PSingleton<PScreenLogger>
	{
		...
		static Queue<PScreenLoggerLine> QueuedLines = new Queue<PScreenLoggerLine>();
		...
		public static void Initialize()
		{
			if (instance == null)
			{
				...
				instance = gameObject.AddComponent<PScreenLogger>();
			}
		}
		...
		public static void Log(string toLog)
		{
			...
			for (int i = 0; i < lines.Length; i++)
				QueuedLines.Enqueue(new PScreenLoggerLine(lines[i], new Color(Brightness, Brightness, Brightness, Alpha)));
		}
		...
		public static void LogWarning(string toLog)
		{
			...
			for (int i = 0; i < lines.Length; i++)
				QueuedLines.Enqueue(new PScreenLoggerLine(lines[i], new Color(Brightness, Brightness, 0, Alpha)));
		}
		...
		public static void LogError(string toLog)
		{
			...
			for (int i = 0; i < lines.Length; i++)
				QueuedLines.Enqueue(new PScreenLoggerLine(lines[i], new Color(Brightness, 0, 0, Alpha)));
		}
		...
		void AddLine(PScreenLoggerLine line)
		{
